...
- Navigate to `fakenews-bot` folder
- Select `fakenews-bot.bot` file
...
msbot clone services --name "fakenews-bot" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
